...
import (
	...
	goonvif "github.com/stefan-kiss/onvif"
	"github.com/stefan-kiss/onvif/device"
	sdk "github.com/stefan-kiss/onvif/sdk/device"
	"github.com/stefan-kiss/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/stefan-kiss/onvif/gosoap for pretty printing response
